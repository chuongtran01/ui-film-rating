...
import DataTablePopoverText from "@/components/data-table/data-table-popover-text";
...
function DataTableToolbarFilter<TData>({ column }: DataTableToolbarFilterProps<TData>) {
  {
    ...
    const onFilterRender = React.useCallback(() => {
      ...
      switch (columnMeta.variant) {
        ...
        case "popoverText":
          return <DataTablePopoverText column={column} title={columnMeta.label ?? column.id} />;
