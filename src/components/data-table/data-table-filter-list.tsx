        ...
        <div className="min-w-[72px] text-center">
          {index === 0 ? (
            ...
            <Select value={joinOperator} onValueChange={(value: JoinOperator) => setJoinOperator(value)}>
              <SelectTrigger aria-label="Select join operator" aria-controls={joinOperatorListboxId} className="h-8 rounded lowercase [&[data-size]]:h-8">
...
function onFilterInputRender<TData>({
  ...
  switch (filter.variant) {
    ...
    case "multiSelect": {
      ...
      const selectedValues = multiple ? (Array.isArray(filter.value) ? filter.value : []) : typeof filter.value === "string" ? filter.value : undefined;
