...
import { ArrowDownIcon, ArrowRightIcon, ArrowUpIcon, CheckCircle2, CircleHelp, CircleIcon, CircleX, Timer } from "lucide-react";
import { customAlphabet } from "nanoid";

import { generateId } from "@/lib/id";

export function generateRandomTask(): any {
  return {
    // id: generateId("task"),
...
export function getPriorityIcon(priority: any) {
  const priorityIcons = {
    high: ArrowUpIcon,
    low: ArrowDownIcon,
