const formatterService = {
  formatDate: (date: Date | string | number | undefined, opts: Intl.DateTimeFormatOptions = {}) => {
    if (!date) return "";
  ...
  formatDateTimeUTC: (date: Date | string | number | undefined, opts: Intl.DateTimeFormatOptions = {}) => {
    if (!date) return "";
